...
namespace Aerocord
{
	...
	public class DarkModeCS
	{
		...
		public DarkModeCS(Form _Form, bool _ColorizeIcons = true, bool _RoundedPanels = false, bool _DarkMode = true)
		{
			...
			IsDarkMode = IsDarkModeCSEnabled && _DarkMode;
		...
		public void ThemeControl(Control control)
		{
			...
			switch (control.GetType().Name)
			{
				...
				case "ToolStrip":
					...
					break;
				case "ToolStripPanel": //<- empty area around ToolStrip
					control.GetType().GetProperty("BackColor")?.SetValue(control, control.Parent.BackColor);
					break;
